...
No se dispone de un análisis integral que permita determinar la evolución temporal, la distribución territorial y los factores asociados a los nacimientos en madres menores de 18 años durante el período 2009–2023.
...
* si el nivel educativo se asocia de manera sistemática con la maternidad temprana, y si el fenómeno presenta patrones de agrupamiento espacial estadísticamente identificables.

* Por lo tanto, el problema científico consiste en caracterizar la dinámica temporal y espacial de la maternidad en menores de 18 años e identificar los factores territoriales y educativos asociados a su ocurrencia.

Preguntas de investigación:

* ¿Cómo ha evolucionado la proporción de nacimientos en madres menores de 18 años entre 2009 y 2023?

* ¿Existen diferencias territoriales significativas en la distribución del fenómeno?

* ¿Se observa mayor prevalencia en áreas rurales en comparación con áreas urbanas?

* ¿Existe asociación entre el nivel educativo de la madre y la maternidad temprana?

* ¿Se presentan patrones de agrupamiento espacial estadísticamente significativos?
...
* Comparar la prevalencia del fenómeno entre áreas rurales y urbanas.

* Detectar y medir la presencia de agrupamiento espacial mediante técnicas de análisis geográfico.
